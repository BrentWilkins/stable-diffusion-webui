...
![A screenshot of the txt2img UI](screenshot.png)

## AWS EC2 Version

This is a fork of [AUTOMATIC1111/stable-diffusion-webui](https://github.com/AUTOMATIC1111/stable-diffusion-webui/) based on the main version on 17 March 2023.

This repo contains a [setup script](example.org)
...
```shell
git clone https://github.com/mw77/stable-diffusion-webui.git
```
